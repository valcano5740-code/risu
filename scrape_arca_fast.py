...
def get_cookies_and_scrape():
    print("🌐 브라우저를 엽니다. 아카라이브에 로그인(QR 등) 해 주세요.")
    ...
    with sync_playwright() as p:
        ...
        input("\n👉 [중요] 로그인이 완료되면 이 터미널 창에서 [Enter] 키를 눌러주세요...")
        
        print("\n🍪 쿠키 추출 중...")
        cookies = browser.cookies("https://arca.live")
        cookie_dict = {cookie['name']: cookie['value'] for cookie in cookies}
        
        print("✅ 쿠키 추출 완료! 브라우저를 닫고 고속 스크래핑을 시작합니다...")
        browser.close()
