...
(async () => {
  ...
  const _I18N = {
    en: {
      ...
      btn_backup_all: "Backup All Settings",
      btn_restore_all: "Restore Settings",
      st_backup_done: "All settings backed up successfully.",
      st_restore_done: "Settings restored. Please reload settings page.",
...
\`rp_persona_evolution_state\` | \`rp_persistent_memory\` | \`rp_arc_memory\` | \`rp_turn_trace\` | \`rp_facet_activation_ledger\` | \`rp_recent_world_entries\` | \`rp_world_encyclopedia\`</textarea>
    ...
    ko: {
      ...
      tab_common: "공통 프롬프트",
      tab_preset1_old: "프리셋 1 (대화 요약)",
      tab_preset2_old: "프리셋 2 (대화 요약)",
      tab_preset1_new: "프리셋 1 (대화 요약 + 디렉터)",
      tab_preset2_new: "프리셋 2 (대화 요약 + 디렉터)",
      tab_char_extract: "캐릭터 설정 추출",
      tab_preset3: "설정 3",
      tab_preset4: "설정 4",
      sec_a: "메인 모델 (요약/추출)",
      sec_b: "보조 모델 (분석/보조)",
      sec_embed_title: "임베딩 모델 (벡터화)",
      embed_warn:
        "⚠️ 주의: 임베딩 모델을 변경하면 기존 벡터 데이터와 호환되지 않아 인덱스를 새로 구축해야 합니다.",
      lbl_provider: "제공자",
      lbl_format: "요청 형식",
      lbl_url: "요청 URL",
      lbl_key: "API 키",
      ...
      lbl_temp: "온도",
      lbl_concur: "요청 처리 방식",
      opt_concurrent: "병렬 처리 (빠르지만 부하 증가)",
      opt_sequential: "순차 처리 (가장 안정적)",
      sec_lore_calls: "로어북 쓰기 설정",
      tag_temp_closed: "닫힘",
      warn_kb_feature_enable:
        "⚠️ 주의: 「캐릭터 지식 분석」 모드를 켜면 기본 캐릭터 프롬프트 구조가 변경되어 기존 CBS 구문이 고장날 수 있습니다. 설정 가이드를 먼저 확인하고 필요시 캐릭터 프롬프트를 수동 조정해주세요.",
      opt_vec_card_reorg: "캐릭터 지식 분석만 사용",
      opt_vec_preset1: "프리셋 1 (캐릭터 지식 분석 + 벡터 검색)",
      opt_vec_preset2: "프리셋 2 (캐릭터 지식 분석 + 벡터 검색)",
      lore_warn:
        "⚠️ 주의: 에이전트가 실행되는 도중에는 로어북을 직접 수정하지 마세요. 에이전트가 내용을 덮어버릴 수 있습니다.",
      ...
      sec_card_settings: "캐릭터별 플러그인 적용 설정",
      lbl_card_name: "캐릭터",
      lbl_memory_extract: "플러그인 활성화 및 디렉터 모드 설정",
      lbl_vector_search_card: "벡터 검색 및 캐릭터 지식 분석 모드 설정",
      lbl_card_disabled: "이 캐릭터에선 플러그인 완전히 끄기",
      btn_continue_chat: "채팅 이어가기",
      dlg_continue_chat_title: "이어갈 채팅 선택",
      dlg_continue_chat_empty: "이 캐릭터에는 아직 채팅 대화 기록이 없습니다.",
      dlg_continue_chat_turns: "턴",
      dlg_continue_chat_current: "현재 상태",
      opt_off: "사용 안 함 (끄기)",
      opt_preset1: "프리셋 1",
      opt_preset2: "프리셋 2",
      no_cards: "저장된 캐릭터 카드가 없습니다.",
      sec_cache: "캐시 저장소",
      ...
      btn_backup_all: "전체 설정 백업",
      btn_restore_all: "전체 설정 복원",
      st_backup_done: "전체 설정이 성공적으로 백업되었습니다.",
      st_restore_done: "설정이 복원되었습니다. 페이지를 다시 열어주세요.",
      ...
      mode_guide_title: "📖 모드 및 모델 동작 가이드",
      mode_guide_content: `<div style="border-top: 1px solid rgba(255, 152, 0, 0.1); padding-top: 12px;">
                    <!-- 🎯 모드 선택 (Indigo) -->
                    <div style="border-left: 4px solid var(--pse-accent-indigo); background: rgba(63, 81, 181, 0.05); padding: 8px 12px; border-radius: 8px; margin-bottom: 16px;">
                      <b style="color: var(--pse-accent-indigo); font-size: 14px;">🎯 프리셋 특징</b>
                      <div style="margin-top: 6px; display: grid; gap: 4px; margin-bottom: 8px;">
                        <div>• <b>프리셋 차이:</b> 「프리셋 1」은 일반 캐릭터용, 「프리셋 2」는 세계관이 복잡한 다중 시나리오용입니다.</div>
                        <div>• <b>대화 요약:</b> 길어지는 대화 내용을 효율적으로 압축하여 토큰을 절약하고 기억을 오래 유지시킵니다.</div>
                      </div>
                      ...
                      <div style="background:rgba(63, 81, 181, 0.1); border:1px solid rgba(63, 81, 181, 0.2); padding:8px; border-radius:6px;">
                        ...
                        <div style="font-size:12px; color:var(--pse-text); display:grid; gap:4px;">
                          <div>• <b>디렉터:</b> 시나리오의 흐름과 캐릭터의 반응 방향성을 지시하여 훨씬 더 입체적이고 개성있는 역할극 경험을 줍니다.</div>
                          <div style="color: var(--pse-accent-red); font-size: 11px;">⚠️ 디렉터 개입 시 캐릭터의 연기가 사실적으로 변하므로, 사용자가 억지로 성격을 바꾸기 힘들어질 수 있습니다.</div>
                          <div style="color: var(--pse-accent-red); font-size: 11px;">⚠️ 캐릭터 봇의 프롬프트를 상당히 무시하고 재해석할 수 있으니 주의하세요.</div>
                          <div>• <b>캐릭터 지식 분석:</b> 캐릭터의 방대한 정보 데이터를 분석하여 AI가 가장 잘 이해할 수 있는 구조로 즉석에서 재조립합니다.</div>
                          <div>• <b>벡터 검색:</b> 단순 단어 매칭 수준을 넘어 문맥의 의미를 파악하는 고차원 검색 기술로, 대화에 딱 맞는 지식만 영리하게 불러옵니다.</div>
                        </div>
                      </div>
                    </div>
...
[
  ...
  async function renderSettingsUI() {
        ...
        .join("")}
          ...
          <div class="pse-page" data-page="8">
            ...
            <div style="display:flex;gap:8px;margin-bottom:12px;">
              <button id="pse-backup-all" class="pse-btn" type="button" style="flex:1;padding:7px 12px;font-size:12px;background:var(--pse-accent-teal, #009688);">${_T.btn_backup_all || "Backup All Settings"}</button>
              <button id="pse-restore-all" class="pse-btn" type="button" style="flex:1;padding:7px 12px;font-size:12px;background:#607D8B;">${_T.btn_restore_all || "Restore Settings"}</button>
              <input id="pse-restore-all-input" type="file" accept=".json,application/json" style="display:none;" />
            </div>
      ...
      try {
        ...
        wrap.innerHTML = characters
          .map((c, idx) => {
            ...
            const cs = { card_disabled: 0, memory_extract: "2", vector_search: "2", ...(cardSettings[cid] || {}) };
    ...
    document.getElementById("pse-backup-all")?.addEventListener("click", () => {
      try {
        const dataStr = JSON.stringify(configCache, null, 2);
        const blob = new Blob([dataStr], { type: "application/json" });
        const url = URL.createObjectURL(blob);
        const a = document.createElement("a");
        a.href = url;
        a.download = "risuai_agent_backup_" + Date.now() + ".json";
        ...
        showStatus(_T.st_backup_done || "Backup successful.", "ok");
      } catch (e) {
        showStatus((_T.st_save_fail || "Backup failed: ") + (e?.message || String(e)), "err");
      }
    });

    const restoreInput = document.getElementById("pse-restore-all-input");
    document.getElementById("pse-restore-all")?.addEventListener("click", () => {
      restoreInput?.click();
    });
    restoreInput?.addEventListener("change", (e) => {
      ...
      reader.onload = async (event) => {
        try {
          ...
          const newConfig = { ...configCache, ...parsed };
          await saveConfigFromUI(newConfig);
          await refreshConfig();
          showStatus(_T.st_restore_done || "Restore successful.", "ok");
        } catch (err) {
          showStatus((_T.st_save_fail || "Restore failed: ") + (err?.message || String(err)), "err");
        }
        e.target.value = "";
      };
    ...
    return (async (messages, type) => {
      ...
      if (type === "display") {
        ...
        try {
          ...
          const displayCardCfg = { card_disabled: 0, memory_extract: "2", vector_search: "2", ...(displayCardSettings[displayCharId] || {}) };
      ...
      const cardCfg = { card_disabled: 0, memory_extract: "2", vector_search: "2", ...(cardSettings[charId] || {}) };
